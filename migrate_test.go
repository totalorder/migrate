...
import (
	...
	dStub "github.com/totalorder/migrate/v3/database/stub"
	"github.com/totalorder/migrate/v3/source"
	sStub "github.com/totalorder/migrate/v3/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/totalorder/migrate/v3/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/totalorder/migrate/v3/source/stub"`
